import { AnalysisResponse, DimensionFinding } from '../core/contracts';
...
const VULNERABILITY_PATTERNS: Record<string, RegExp> = {
...
export function locateVulnerableLine(code: string, vulnerableLine: string, vulnType: string): number {
...
export function severityToDiagnosticSeverity(severity: string): DiagnosticDescriptor['severity'] {
...
export function buildDiagnosticDescriptors(code: string, result: AnalysisResponse): DiagnosticDescriptor[] {
...
export function buildDiagnosticDescriptor(code: string, result: AnalysisResponse): DiagnosticDescriptor | null {
